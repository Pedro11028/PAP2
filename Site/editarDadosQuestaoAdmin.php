...
<html>
<head>
    <title>Language Quizz- Editar Dados Questao Admin</title>
...
?>
    <div>
        ...
        <div class="containerQuestao alinharQuestao">
            ...
            <img id="imagemQuestao" src="" class="imagemQuestao" title="Clicar para eliminar imagem" onclick="eliminarImagemQuestao()">
...
<script  src="editarDadosQuestaoAdmin.js"></script>
