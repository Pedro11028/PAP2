...
<nav>
	<ul>
		...
		<li id="menuGuardarInfoQuizz" class="criarQuizz">
			<button id="botaoGuardar"></button>
		</li>
		
		<li id="menuAdicionarQuestao" class="criarQuizz">
			<button id="botaoadicionarQuizz" class="bi bi-plus-circle">
				<!-- Icon adicionar do bootstrap link: https://icons.getbootstrap.com/icons/plus-circle/ -->
				<svg id="iconPlus" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
