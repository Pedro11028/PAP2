...
<<<<<<< HEAD
    <div id="navbarColor02" class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
            <form onsubmit="event.preventDefault()" id="menuBarraPesquisa" class="form-inline my-2 my-lg-0"> <input class="form-control mr-sm-2" type="text" placeholder="Search"> <button class="btn btn-secondary my-2 my-sm-0" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button> </form>
			<li id="menuCriarQuestao" class="nav-item"> <a class="nav-link" href="escolherTipoQuestao.html" data-abc="true">Criar Questão</a> </li>
=======
<<<<<<< HEAD
    <div id="navbarColor02" class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
...
=======
    <div id="navbarColor02" class="collapse navbar-collapse" >
        <ul class="navbar-nav mr-auto">
            <form onsubmit="event.preventDefault()" id="menuBarraPesquisa" class="form-inline my-2 my-lg-0"> <input class="form-control mr-sm-2" type="text" placeholder="Search"> <button class="btn btn-secondary my-2 my-sm-0" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button> </form>
			<li id="menuCriarQuestao" class="nav-item"> <a class="nav-link" href="inserirDadosQuizz.php" data-abc="true">Criar Questão</a> </li>
...
=======
=======
				<li  class="nav-item"><button id="menuCancelarQuestao" class="btn btn-secondary my-2 my-sm-0 esquerda" type="submit"><i class="fa-solid fa-outdent"></i> Cancelar</button>
				<button id="menuGuardarQuestao" class="btn btn-secondary my-2 my-sm-0 direita" type="submit">Guardar <i class="fa-solid fa-floppy-disk"></i></button></li>
>>>>>>> 1bc400c5250891d2f526cb902a39df8ecd2aec98
>>>>>>> 2f84d730dd6a50a9d0f6c975c2eb500a7c55fceb
		</li>
		</ul>			
